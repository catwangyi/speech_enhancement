...
import os
import sys
sys.path.append("C:\\Users\\hp-pc\\Desktop\\myProject\\")
from model import MBNET_withlargeband
...
if __name__ == "__main__":
    checkpoint = torch.load('MBNetWithLargeBand\epoch_0.pth',map_location=torch.device('cpu'))
    dataset = MyDataset(is_training=False)
    model_state_dict = checkpoint['model']
    model = MBNET_withlargeband()
